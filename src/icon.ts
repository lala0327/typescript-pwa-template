...
library.add(
  faBookOpen, faHouse, faList, faBell, faGear, faMagnifyingGlass, faAngleRight, faCircleCheck, faInfoCircle, faExclamationCircle, faTimesCircle, faCheck, faTimes, faArrowUpFromBracket, faFacebook, faGoogle, faLine
);
